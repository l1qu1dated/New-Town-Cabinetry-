	...
	<body class="wide">
		...
		<div class="wrapper">
			...
			<section class="padd-tb-60">
				...
				<div align="right">
							<button type="button" class="btn btn-small btn-dark-blue" onclick="window.location='{{ URL::route('suppliers.create'); }}'" >Add Supplier</button>
					</div>
					<div class="row">
										...
										<table class="table table-hover">
											...
											<tbody>
												...
												<tr>
													...
													<td style="width:5%"><a class="btn btn-small btn-blue" href="{{ URL::to('suppliers/' . $value->id . '/details') }}"><i class="fa fa-list-alt"></i> Details</a></td>
													<td style="width:5%"><a class="btn btn-small btn-green" href="{{ URL::to('suppliers/' . $value->id . '/edit') }}"><i class="fa fa-edit"></i> Edit</a></td>
													<td style="width:5%">
													{{ Form::open(array('url' => 'suppliers/' . $value->id, 'class' => 'pull-right')) }}
                    									{{ Form::hidden('_method', 'DELETE') }}
                    									<button type="submit" onclick=" return confirm('Are you sure you want to delete this supplier?')" class="btn btn-danger">
