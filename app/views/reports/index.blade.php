						...
						<div class="col-md-12">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									...
									{{Form::open(array('url' => 'reports/1/details', 'name' => 'add', 'id' => 'reportsForm'))}}

										<fieldset>
    										<!--<legend>Customer Invoice Information</legend>-->

											<div class="form-group col-md-6"><!-- Product Name field start-->
												{{ Form::label('startDate', 'Start Date', array('class' => 'col-xs-3 control-label')) }}
											...
											<div class="form-group col-md-6"><!-- Product Name field start-->
												{{ Form::label('endDate', 'End Date', array('class' => 'col-xs-3 control-label')) }}
										...
										<div class="padd-t-20">
											{{ Form::submit('Generate', array('class' => 'btn btn-theme btn-lg btn-block', 'onclick' => 'return confirm("Are you sure you want to generate this report?")')) }}
								...
								<div class="alert alert-danger" role="alert">
									THIS DATE DOES NOT EXIST ON RECORD!
								</div>
								@endif
