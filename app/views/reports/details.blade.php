...
<html lang="en">
	<head>
		<meta charset="utf-8">
		<title>NTC - Revenue Report</title>
		<!-- Mobile Meta -->
...
foreach ($services as $key => $value2) {
...
<?php
$invoicesTotal = $invoicesTotal+$subtotal*1.13;
//$reportTotal = $reportTotal + $invoicesTotal;
?>
@endforeach
								...
								<div class="col-md-6">
									<div class="text-right">
										<ul class="list-unstyled">
											<!--<li><strong>Invoices Total:</strong>  {{number_format($invoicesTotal, 2)}}</li>-->
										</ul>
									</div>
								</div>
							</div><!-- ./row -->
							...
							<div class="row padd-tb-10">
								...
								<div class="col-md-6">
									<div class="text-right">
										<ul class="list-unstyled">
											<li><strong>Total Revenue:</strong>  ${{number_format($invoicesTotal, 2)}}</li>
										</ul>
