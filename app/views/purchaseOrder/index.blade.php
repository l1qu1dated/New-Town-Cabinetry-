...
<html lang="en">
	<head>
		<script></script>
		<meta charset="utf-8">
		<title>NTC - Purchase Order</title>
		<!-- Mobile Meta -->
		...
		<div class="wrapper">
			...
			<header id="header">
					...
					<div class="container">
						...
						<div class="navbar-collapse collapse">
							<ul class="nav navbar-nav navbar-right">
								...
								<!--search field-->
								{{ Form::open(array('method' => 'GET', 'url' => 'purchaseOrder', 'class'=>'form navbar-form navbar-right searchform')) }}
				...
				@endif
					...
					<div align="right">
							<button type="button" class="btn btn-small btn-dark-blue" onclick="window.location='{{ URL::route('purchaseOrder.create'); }}'" >Add Purchase Order</button>
					</div>
							...
							<div class="padd-tb-10">
								<div class="panel panel-dark-blue">
									<div class="panel-heading">
										<h3 class="panel-title"><i class="fa fa-th-list"></i>Purchase Orders</h3>
									</div>
									<div class="panel-body">
										...
										<table class="table table-hover">
											...
											<tbody>
												...
												<tr>
													<td style="width:30%"><strong>{{ $value->supplierName }}</strong></td>
													<td style="width:30%">{{ $value->date }}</td>
													<td style="width:30%">{{ $value->details}}</td>
													<td style="width:5%"><a class="btn btn-small btn-blue" href="{{ URL::to('purchaseOrder/' . $value->id) }}"><i class="fa fa-list-alt"></i> Details</a></td>
													<td style="width:5%"><a class="btn btn-small btn-green" href="{{ URL::to('purchaseOrder/' . $value->id . '/edit') }}"><i class="fa fa-edit"></i> Edit</a></td>

													<td style="width:5%">
													{{ Form::open(array('url' => 'purchaseOrder/' . $value->id, 'class' => 'pull-right')) }}
                    									{{ Form::hidden('_method', 'DELETE') }}
                    									<button type="submit" onclick=" return confirm('Are you sure you want to delete this purchase order?')" class="btn btn-danger">
