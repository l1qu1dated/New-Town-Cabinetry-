...
<html lang="en">
	<head>
		<meta charset="utf-8">
		<title>NTC - Invoices Details</title>
		<!-- Mobile Meta -->
							...
							<div class="row padd-tb-20">
								...
								<div class="col-md-6">
									<ul class="list-unstyled text-right">
										...
										<li><strong>Date Issue #:</strong>  {{$invoice->date}}</li>
									</ul>
								</div>
							</div>
									...
									<div class="panel panel-default">
										...
										<div class="panel-body">
											<ul class="list-unstyled">
												...
												<li><strong>Province:</strong> {{$invoice->province}}</li>
												<li><strong>Country:</strong> {{$invoice->country}}</li>
