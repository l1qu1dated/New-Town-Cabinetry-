	...
	<body class="wide">
						...
						<div class="col-md-12">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									{{Form::open(array('url' => 'invoices', 'name' => 'add', 'id' => 'invoiceForm'))}}
    										...
    										<div id="invoice-line-item" class="row row-eq-height">
    											...
    											<div class="col-md-2">
    												<div class="form-group">
														...
														<select name="supplier1" id="supplier1" class="form-control"></select>
    												</div>
    											</div>
										...
										<div class="padd-t-20">
											{{ Form::submit('Add', array('class' => 'btn btn-theme btn-lg btn-block', 'onclick' => 'return confirm("Are you sure you want to add this invoice?")')) }}
		...
		<script type="text/javascript">
			...
			$('#category1').change(function() {
				$.get("{{ url('loadSuppliers') }}", { selectedCategory: $("#category1").val() }, function(data) {
					$("#supplier1").empty();
					$("#product1").empty();

					if (data) {
						$("#supplier1").append("<option value='none'>Select a supplier</option>");

						$.each(data, function(key, value) {
							$("#supplier1").append("<option value = '" + key + "'>" + value + "</option>");
						});
					}
				});
			});
			...
			$("#supplier1").change(function() {
				$.get("{{ url('loadProducts') }}", { selectedSupplier: $("#supplier1").val() }, function(data) {
					$("#product1").empty();

					if (data) {
						$("#product1").append("<option value='none'>Select a product</option>");
