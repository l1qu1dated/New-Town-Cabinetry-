	...
	<body class="wide">
		...
		<div class="wrapper">
			...
			<section class="padd-tb-60">
				...
				<div align="right">
						<button type="button" class="btn btn-small btn-dark-blue" onclick="window.location='{{ URL::route('products.create'); }}'" >Add Product</button>
					</div>
					<div class="row">
...
<td style="width:15%"><strong>{{ $value->name }}</strong></td>
													...
													<td style="width:5%"><a class="btn btn-small btn-blue" href="{{ URL::to('products/' . $value->id . '/details') }}"><i class="fa fa-list-alt"></i> Details</a></td>
													<td style="width:5%"><a class="btn btn-small btn-green" href="{{ URL::to('products/' . $value->id . '/edit') }}"><i class="fa fa-edit"></i> Edit</a></td>
													<td style="width:5%">
													{{ Form::open(array('url' => 'products/' . $value->id, 'class' => 'pull-right')) }}
                    									{{ Form::hidden('_method', 'DELETE') }}
                    									<button type="submit" onclick=" return confirm('Are you sure you want to delete this product?')" class="btn btn-danger">
