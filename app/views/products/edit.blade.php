								...
								<div class="panel-body">
									{{Form::model($product, array('route' => array('products.update', $product->id),
										...
										<div class="form-group"><!-- Supplier Product Id field start-->
											...
											<div class="has-error">
											@endif
											{{ Form::text('supplierProductId', null, array('class' => 'form-control', 'disabled')) }}
										</div>
										...
										<div class="form-group"><!-- Supplier name field start-->
											...
											<select name="suppliers_id" id="suppliers_id" class="form-control">
												@foreach($suppliers as $id => $name)
													<option value="{{ $id }}" <?php if ($product->supplierId == $id) {echo 'selected="selected"';}?>>{{ $name }}</option>
												@endforeach
											</select>
										</div>
										...
										<div class="form-group"><!-- Category Name field start-->
											...
											<select name="categories_id" id="categories_id" class="form-control">
												...
												@foreach($categories as $id => $name)
													<option value="{{ $id }}" <?php if ($product->categoryId == $id) {echo 'selected="selected"';}?>>{{ $name }}</option>
												@endforeach
											</select>
										</div>
