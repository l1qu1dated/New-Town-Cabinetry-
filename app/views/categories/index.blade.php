	...
	<body class="wide">
		...
		<div class="wrapper">
			...
			<section class="padd-tb-60">
				...
				@endif
					<div align="right">
						<button type="button" class="btn btn-small btn-dark-blue" onclick="window.location='{{ URL::route('categories.create'); }}'" >Add Category</button>
					</div>
					<div class="row">
										...
										<table class="table table-hover">
											...
											<tbody>
												...
												<tr>
													...
													<td style="width:5%"><a class="btn btn-small btn-green" href="{{ URL::to('categories/' . $value->id . '/edit') }}"><i class="fa fa-edit"></i> Edit</a></td>
													<td style="width:5%">
