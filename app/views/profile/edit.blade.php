					...
					<div class="container">
						...
						<div class="navbar-collapse collapse">
							<ul class="nav navbar-nav navbar-right">
								...
								</li> <!--menu li end here--><!--menu li end here-->
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									{{Form::model($user, array('route' => array('profile.update', $user->id),
										...
										<div class="form-group"><!-- Username field start-->
										...
										<div class="form-group"><!-- First Name field start-->
										...
										<div class="form-group"><!-- Last Name field start-->
										...
										<div class="form-group"><!-- Phone field start-->
										...
										<div class="padd-t-20">
											{{ Form::submit('Edit', array('class' => 'btn btn-theme btn-lg btn-block', 'onclick' => 'return confirm("Are you sure you want to edit your profile?")')) }}
